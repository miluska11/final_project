...
<body class="font-sans">
    ...
    <li class="border-t border-b border-gray-700 py-4">
        <h4 class="py-2 px-4 text-white font-bold">ALUMNO</h4>
    </li>
    <li class="py-2 px-4">
        <h4 class="text-gray-400">MENU ALUMNO</h4>
    </li>
    <li class="py-2 px-4">
        <a href="alumnos_read.php" class="flex items-center space-x-2">
            <span class="material-symbols-outlined text-gray-400">ambient_screen</span>
            <span class="text-white">Ver Calificaciones</span>
        </a>
    </li>
    <li class="py-2 px-4">
        <a href="admin_estudiantes/crud_ALUMNO.php" class="flex items-center space-x-2">
            <span class="material-symbols-outlined text-gray-400">ambient_screen</span>
            <span class="text-white">Administra tus Clases</span>
        </a>
    </li>
</ul>
    </aside>
