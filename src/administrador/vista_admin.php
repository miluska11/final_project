...
<body class="font-sans">
    ...
    <aside id="menu1" class="h-screen w-1/5 bg-gray-800 text-white">
            <div class="py-8 text-center">
                ...
                <img src="/img/logo.jpg" alt="logo" class="circular-image w-32 h-32 mx-auto rounded-full">
            ...
            <ul class="mt-6 space-y-4">
                ...
                <li class="py-2 px-4">
                    <a href="admin_maestro/crud_maestros.php" class="flex items-center space-x-2">
                        <span class="material-symbols-outlined">group</span>
                        <span>Maestros</span>
                    </a>
                </li>
                <li class="py-2 px-4">
                    <a href="admin_estudiantes/crud_alumnos.php" class="flex items-center space-x-2">
                        <span class="material-symbols-outlined">ambient_screen</span>
                        <span>Alumnos</span>
                    </a>
                </li>
                <li class="py-2 px-4">
                    <a href="clases/clases_vista.php" class="flex items-center space-x-2">
